...
const InteriorGenerator: React.FC<InteriorGeneratorProps> = ({
  state,
  onStateChange,
  onSendToViewSync,
}) => {
  ...
  const updatePrompt = useCallback(
    (
      type: "style" | "roomType" | "lighting" | "colorPalette",
      newValue: string,
      oldValue: string,
    ) => {
  ...
  const handleGenerate = async () => {
    if (!sourceImage) {
      onStateChange({
        error: "Vui lòng tải lên một hình ảnh phác thảo hoặc không gian.",
      });
      return;
    }
  ...
  const handleUpscale = async () => {
    ...
    try {
      ...
      const upscalePrompt =
        "Upscale this interior design rendering to a high resolution. Enhance the details, textures, and lighting to make it look photorealistic and professional. Do not change the composition or the core design.";
    ...
    <div className="flex flex-col gap-8">
      ...
      <div>
        ...
        <p className="text-text-secondary dark:text-gray-300 mb-6">
          Tải lên ảnh phác thảo, mặt bằng hoặc ảnh thực tế của một không gian,
          AI sẽ giúp bạn hoàn thiện với đầy đủ vật liệu, ánh sáng và đồ đạc.
        </p>
        ...
        <div className="space-y-6 bg-main-bg/50 dark:bg-dark-bg/50 p-6 rounded-xl border border-border-color dark:border-gray-700">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-start">
            ...
            <div className="space-y-6">
              <div>
                <label className="block text-sm font-medium text-text-secondary dark:text-gray-400 mb-2">
                  1. Tải Lên Ảnh Phác Thảo / Không Gian
                </label>
                <ImageUpload
            ...
            <div className="space-y-4 flex flex-col">
              <div>
                <label
                  htmlFor="custom-prompt-interior"
