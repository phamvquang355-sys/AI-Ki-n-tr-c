...
const RenovationIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15 12H9m12 4.5l-3-3m0 0l-3 3m3-3v9"
    />
  </svg>
);
const LightBulbIcon = () => (
...
const MagicWandIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M18 10l2-2M13 5l2-2M8 15l-2 2"
    />
  </svg>
);
const PhotoIcon = () => (
...
const InteriorIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2h8a2 2 0 002-2v-1a2 2 0 012-2h1.945M7.881 4.043C9.227 3.387 10.76 3 12.368 3c1.608 0 3.14.387 4.486 1.043m-8.972 1.043C5.69 6.208 4.862 7.55 4.438 9h15.124c-.424-1.45-1.252-2.792-2.586-3.914m-10.082 3.914H18.23"
    />
  </svg>
);
const UrbanPlanningIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4 4h7v7H4V4zM13 4h7v12h-7V4zM4 13h7v7H4v-7z"
    />
  </svg>
);
const LandscapeIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 21v-8.25m0 0a4.5 4.5 0 00-4.5 4.5h9a4.5 4.5 0 00-4.5-4.5zm0-8.25a4.5 4.5 0 014.5 4.5h-9a4.5 4.5 0 014.5-4.5zM12 3v.75m0-3.75a4.5 4.5 0 00-4.5 4.5h9a4.5 4.5 0 00-4.5-4.5z"
    />
  </svg>
);
const ViewGridIcon = () => (
...
const ColorSwatchIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12.5a2 2 0 002-2v-6.5a2 2 0 00-2-2H7"
    />
  </svg>
);
const UpscaleIcon = () => (
...
const MoodboardIcon = () => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M4 5a1 1 0 011-1h4a1 1 0 011 1v4a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h4a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM13 5a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1h-6a1 1 0 01-1-1V5zM13 15a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 01-1 1h-2a1 1 0 01-1-1v-4z"
    />
  </svg>
);
const HistoryIcon = () => (
...
const VirtualTourIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 3a9 9 0 0 0-9 9h18a9 9 0 0 0-9-9z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
const FengShuiIcon = () => (
  ...
  >
    ...
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 3v2m0 14v2m9-9h-2M5 12H3m14.657-6.657l-1.414 1.414M6.757 17.243l-1.414 1.414m12.728 0l-1.414-1.414M6.757 6.757l-1.414-1.414"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 15l-3-6 3 6 3-6-3 6z"
    />
  </svg>
);
const PencilAltIcon = () => (
...
const Navigation: React.FC<NavigationProps> = ({
  ...
  const isGroupActive = utilityToolsGroup.tools.some(
    (item) => item.tool === activeTool,
  );
  ...
  const renderItem = (item: {
    ...
    >
      <span
        className={`${activeTool === item.tool ? "text-white" : "text-gray-400 group-hover:text-[#7f13ec]"} transition-colors`}
      >
        {item.icon}
      </span>
    ...
    <>
      ...
      >
        <div className="h-full flex flex-col p-4 overflow-y-auto scrollbar-hide">
          ...
          <h2 className="text-xs font-bold text-text-secondary dark:text-gray-500 uppercase tracking-wider px-4 pb-3 hidden md:block">
            Công cụ chính
          </h2>
          ...
          <nav className="flex-1 space-y-1">
            ...
            <div className="w-full">
              ...
              <div
                className={`overflow-hidden transition-all duration-300 ease-in-out ${isGroupOpen ? "max-h-[1000px] opacity-100 mt-1" : "max-h-0 opacity-0"}`}
              >
