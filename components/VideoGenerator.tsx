...
const exteriorSuggestions = [
  {
    label: "Tiếp Cận Công Trình Từ Xa (Flycam)",
    prompt: "Một video flycam bay chậm rãi tiến lại gần công trình từ xa.",
  },
  {
    label: "Bay Vòng Quanh Toàn Cảnh (Orbit)",
    prompt:
      "Một video flycam bay vòng quanh công trình để thể hiện mọi góc cạnh.",
  },
  {
    label: "Góc Nhìn Thấp Hùng Vĩ (Low Angle)",
    prompt:
      "Một video quay từ góc thấp, di chuyển camera từ từ lên cao để thể hiện sự hoành tráng.",
  },
  {
    label: "Time-lapse Chuyển Giao Ngày Đêm",
    prompt:
      "Một video time-lapse cho thấy sự thay đổi ánh sáng từ ngày sang đêm trên công trình.",
  },
  {
    label: "Góc Nhìn Người Đi Bộ Tiếp Cận",
    prompt:
      "Một video mô phỏng góc nhìn người đi bộ tiến lại gần cổng chính của công trình.",
  },
  {
    label: "Nâng Cao Tầm Nhìn (Crane Shot)",
    prompt:
      "Một video quay từ góc thấp, di chuyển camera thẳng đứng lên cao giống như một cần cẩu (crane shot), thể hiện sự cao lớn của công trình.",
  },
  {
    label: "Hiệu Ứng Vertigo (Dolly Zoom)",
    prompt:
      "Một video sử dụng hiệu ứng dolly zoom, trong đó camera di chuyển ra xa trong khi ống kính zoom vào, giữ nguyên kích thước công trình nhưng thay đổi phối cảnh nền.",
  },
  {
    label: "Hyper-lapse Dòng Thời Gian Chuyển Động",
    prompt:
      "Một video hyper-lapse (time-lapse di chuyển) tiến lại gần công trình, cho thấy sự nhộn nhịp của xe cộ và người đi bộ xung quanh.",
  },
  {
    label: "Đường Bay Cong Giờ Vàng (Arc shot)",
    prompt:
      "Một video flycam bay theo một đường cong rộng trong giờ vàng (bình minh hoặc hoàng hôn), với ánh nắng ấm áp chiếu xiên lên mặt tiền công trình.",
  },
  {
    label: "Hiện Ra Từ Sau Vật Cản (Reveal Shot)",
    prompt:
      "Một video flycam bay vòng quanh, ban đầu bị che khuất bởi cây cối hoặc một công trình khác, sau đó dần dần hiện ra toàn bộ công trình.",
  },
];

const interiorSuggestions = [
  {
    label: "Lia Máy Quét Toàn Cảnh Phòng (Pan)",
    prompt:
      "Một video lia máy quay chậm rãi từ trái sang phải để bao quát toàn bộ không gian phòng.",
  },
  {
    label: "Bước Vào Không Gian (Walk-in)",
    prompt:
      "Một video mô phỏng góc nhìn người đi bộ từ từ bước vào phòng từ cửa chính.",
  },
  {
    label: "Cận Cảnh Chi Tiết Nội Thất (Zoom)",
    prompt:
      "Một video tập trung zoom vào một chi tiết nội thất đặc sắc (VD: bộ sofa, bàn ăn, đèn trang trí).",
  },
  {
    label: "Hướng Nhìn Ra Cửa Sổ (Window View)",
    prompt:
      "Một video di chuyển camera hướng về phía cửa sổ lớn, thể hiện khung cảnh bên ngoài.",
  },
  {
    label: "Bao Quát Từ Trần Xuống (Top-down)",
    prompt:
      "Một video quay từ trên cao xuống, bao quát toàn bộ layout và cách bố trí nội thất.",
  },
  {
    label: "Tập Trung Vào Chi Tiết (Push-in)",
    prompt:
      "Một video di chuyển camera chậm rãi từ góc rộng của căn phòng và tiến thẳng vào một chi tiết cụ thể, như một bức tranh hoặc một lọ hoa.",
  },
  {
    label: "Mở Rộng Ra Toàn Cảnh (Pull-back)",
    prompt:
      "Một video bắt đầu từ một cảnh quay cận cảnh một đồ vật, sau đó từ từ kéo camera ra xa để tiết lộ toàn bộ không gian nội thất.",
  },
  {
    label: "Di Chuyển Theo Lối Đi (Follow Path)",
    prompt:
      "Một video mô phỏng góc nhìn người đi bộ di chuyển theo một con đường tự nhiên trong nhà, ví dụ từ phòng khách đến nhà bếp.",
  },
  {
    label: "Lướt Theo Chi Tiết Kiến Trúc (Detail Pan)",
    prompt:
      "Một video lia máy quay dọc theo một chi tiết kiến trúc, như một trần nhà độc đáo, một hệ lam trang trí, hoặc một bức tường có vật liệu đặc biệt.",
  },
  {
    label: "Time-lapse Vệt Nắng Trong Phòng",
    prompt:
      "Một video time-lapse quay cảnh ánh nắng mặt trời di chuyển qua căn phòng, tạo ra các vệt sáng và bóng đổ thay đổi trên đồ đạc và sàn nhà.",
  },
];
...
const VideoGenerator: React.FC<VideoGeneratorProps> = ({
  ...
  if (isMaintenanceMode) {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-8 bg-surface dark:bg-[#121212] rounded-xl border border-border-color dark:border-gray-700 shadow-lg">
        ...
        <h2 className="text-3xl font-bold text-text-primary dark:text-white mb-3">
          Tính năng đang bảo trì
        </h2>
        <p className="text-text-secondary dark:text-gray-400 max-w-md text-lg">
          Hệ thống tạo video đang được nâng cấp để cải thiện chất lượng và tốc
          độ.
          <br />
          Vui lòng quay lại sau hoặc trải nghiệm các tính năng khác của OPZEN
          AI.
        </p>
      </div>
    );
  ...
  const [renderSource, setRenderSource] = useState<"google" | "veo3_external">(
    "veo3_external",
  );
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      onStateChange({ loadingMessage: "Đang gửi yêu cầu tạo video..." });
      ...
      if (renderSource === "google") {
        ...
        url = await externalVideoService.generateVideoExternal(
          prompt,
          backendUrl,
          startImage || undefined,
        );
      ...
      if (
        errorMessage.includes("Quá thời gian chờ") ||
        errorMessage.includes("Timeout")
      ) {
        errorMessage =
          "Hệ thống đang bận hoặc quá thời gian chờ. Vui lòng thử lại.";
      }
  ...
  return (
    <div>
      ...
      <p className="text-text-secondary dark:text-gray-300 mb-6">
        Tạo các video chuyển động, fly-through, hoặc diễn hoạt kiến trúc từ mô
        tả hoặc hình ảnh ban đầu.
      </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-main-bg/50 dark:bg-dark-bg/50 p-4 rounded-xl border border-border-color dark:border-gray-700">
            <label className="block text-sm font-medium text-text-secondary dark:text-gray-400 mb-3">
              2. Thêm gợi ý chuyển động (Tùy chọn)
            </label>
          ...
          <div>
            <label className="block text-sm font-medium text-text-secondary dark:text-gray-400 mb-2">
              3. Ảnh Bắt Đầu (Tùy chọn)
            </label>
            <div className="max-w-md">
              <ImageUpload
                onFileSelect={(file) => onStateChange({ startImage: file })}
                previewUrl={startImage?.objectURL}
              />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between bg-gray-100 dark:bg-gray-800/50 rounded-lg px-4 py-2 mb-3 border border-gray-200 dark:border-gray-700">
            ...
            {error && (
              <div className="mt-4 p-3 bg-red-100 border border-red-400 text-red-700 dark:bg-red-900/50 dark:border-red-500 dark:text-red-300 rounded-lg text-sm whitespace-pre-wrap">
                {error}
              </div>
            )}
          </div>
            ...
            <div className="sticky top-28">
              <div className="aspect-video bg-main-bg dark:bg-gray-800/50 rounded-lg border-2 border-dashed border-border-color dark:border-gray-700 flex items-center justify-center overflow-hidden">
                {isLoading && (
                  <div className="text-center p-4">
                    <Spinner />
                    <p className="text-text-secondary dark:text-gray-400 mt-4 animate-pulse">
                      {loadingMessage}
                    </p>
                  </div>
                )}
              ...
              {generatedVideoUrl && !isLoading && (
                <button
                  ...
                  className="w-full mt-4 bg-gray-600 hover:bg-gray-700 text-white font-semibold py-3 px-4 rounded-lg transition-colors"
                >
                  Tải xuống Video
                </button>
              )}
