...
const CloudUploadIcon = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className="h-10 w-10 text-gray-300 dark:text-gray-600 group-hover:text-accent transition-colors"
    fill="none"
    viewBox="0 0 24 24"
    stroke="currentColor"
    strokeWidth={1.5}
  ...
  return (
    <div>
      ...
      >
        ...
        <p className="font-medium text-gray-700 dark:text-gray-200 text-sm group-hover:text-accent transition-colors">
          Nhấp để tải ảnh lên
        </p>
